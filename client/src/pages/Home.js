...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div style={heroStyle}>
        <div className="container" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
          <div style={{ flex: 1, minWidth: '300px', paddingRight: '20px' }}>
            <h1 style={{ fontSize: '3.5rem', color: 'var(--accent-primary)', marginBottom: '20px' }}>
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: 'var(--accent-primary)', color: 'var(--text-light)', padding: '20px 0', textAlign: 'center' }}>
